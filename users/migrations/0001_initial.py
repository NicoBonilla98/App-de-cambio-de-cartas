    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(choices=[('Quito', 'Quito'), ('Machala', 'Machala'), ('Guayaquil', 'Guayaquil'), ('Cuenca', 'Cuenca'), ('Ambato', 'Ambato')], default='Quito', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('info', 'Informativo'), ('action', 'Acción'), ('error', 'Error')], default='info', max_length=10)),
