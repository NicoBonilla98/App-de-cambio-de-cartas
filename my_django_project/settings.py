...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': BASE_DIR / 'db_writable.sqlite3',
        }
    }
...
SECURE_HSTS_SECONDS = int(os.environ.get('SECURE_HSTS_SECONDS', '0' if DEBUG else '60'))
...
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'  # Ensure this is set to the desired redirect URL after logout
LOGIN_URL = '/login/'
